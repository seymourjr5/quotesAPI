...
//logic for getting just quote from quotes array
// let arr = [];
// quotes.forEach(element => arr = [...arr, element.quote]);
// console.log(arr);


// logic for selected person quote
// let nQuote = quotes.filter(element => element.person == 'Bill Gates');
// console.log(nQuote);

//add new quotes
// let newQuote = {
//   quote: 'Get ripped or die trying', 
//   person: 'Seymour'
// }
...
//delete quotes
// let quoteId = 5;
// let newQuotes = quotes.filter(element => element.id !== quoteId);
// quotes = newQuotes;
...
// console.log(quotes.splice(7));

// console.log(quotes.splice(1));
